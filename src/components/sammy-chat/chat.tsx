...
export default function Chat() {
  ...
  const SammyProviderProps = {
    ...
    logo: "/miter.png",
    botImage: "/miterhr_logo.jpeg",
    baseUrl,
    width: "500px",
    height: "950px",
    initialChatText: "Hi I'm Miter AI, how can I help you today?",
    botIcon: Bot,
    chatIcon: MessageSquare,
    position: "bottom-right" as const,
    walkthroughFallbackTimeout: 0,
    ...
    walkthroughOverrideDomainUrl: "https://miter-staging.onrender.com/",
    fixed: true,
    open: false,
  };
